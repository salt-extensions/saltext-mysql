...
The saltext-mysql project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-mysql.git
...
* Writing blog posts
* Sharing your experiences using Salt + MySQL
  on social media
