...
src_dir = repo_path / "src" / " saltext" / "saltext-mysql"
...
for path in Path(__file__).parent.parent.joinpath("src/saltext/saltext-mysql/").glob("*/*.py"):
...
"""
    ...
    all_rst.write_text(
        f"""
.. all-saltext.saltext-mysql.{kind}:
